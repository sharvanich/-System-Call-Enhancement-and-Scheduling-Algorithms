...
forktest(void)
{
  ...
  84:	f7dff0ef          	jal	0 <print>
    exit(1);
  88:	4505                	li	a0,1
  8a:	2be000ef          	jal	348 <exit>
  for(; n > 0; n--){
  8e:	00905963          	blez	s1,a0 <forktest+0x7a>
    if(wait(0) < 0){
  92:	4501                	li	a0,0
  94:	2bc000ef          	jal	350 <wait>
...
stat(const char *n, struct stat *st)
{
 ...
 228:	84aa                	mv	s1,a0
  ...
  r = fstat(fd, st);
 22a:	85ca                	mv	a1,s2
 22c:	174000ef          	jal	3a0 <fstat>
 230:	892a                	mv	s2,a0
  close(fd);
 232:	8526                	mv	a0,s1
 234:	13c000ef          	jal	370 <close>
  return r;
 238:	64a2                	ld	s1,8(sp)
}
 23a:	854a                	mv	a0,s2
