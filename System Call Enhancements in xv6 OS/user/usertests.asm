...
0000000000000118 <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     184:	155040ef          	jal	4ad8 <unlink>
  close(fd1);
     188:	8526                	mv	a0,s1
     18a:	127040ef          	jal	4ab0 <close>
  close(fd2);
     18e:	854a                	mv	a0,s2
     190:	121040ef          	jal	4ab0 <close>
}
...
00000000000001b8 <createtest>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    fd = open(name, O_CREATE|O_RDWR);
     ...
     1e4:	0e5040ef          	jal	4ac8 <open>
    close(fd);
     1e8:	0c9040ef          	jal	4ab0 <close>
  for(i = 0; i < N; i++){
...
000000000000022c <bigwrite>:
{
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    if(fd < 0){
     ...
     28a:	85d2                	mv	a1,s4
     28c:	854a                	mv	a0,s2
     28e:	01b040ef          	jal	4aa8 <write>
      if(cc != sz){
     292:	04951263          	bne	a0,s1,2d6 <bigwrite+0xaa>
    close(fd);
     296:	854a                	mv	a0,s2
     298:	019040ef          	jal	4ab0 <close>
    unlink("bigwrite");
     29c:	8556                	mv	a0,s5
     29e:	03b040ef          	jal	4ad8 <unlink>
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
...
badwrite(char *s)
{
  ...
  for(int i = 0; i < assumed_free; i++){
    ...
    write(fd, (char*)0xffffffffffL, 1);
     32c:	4605                	li	a2,1
     32e:	85d2                	mv	a1,s4
     330:	778040ef          	jal	4aa8 <write>
    close(fd);
     334:	8526                	mv	a0,s1
     336:	77a040ef          	jal	4ab0 <close>
    unlink("junk");
     33a:	854e                	mv	a0,s3
     33c:	79c040ef          	jal	4ad8 <unlink>
  for(int i = 0; i < assumed_free; i++){
  ...
  if(write(fd, "x", 1) != 1){
    ...
    exit(1);
     3a0:	4505                	li	a0,1
     3a2:	6e6040ef          	jal	4a88 <exit>
  }
  close(fd);
     3a6:	8526                	mv	a0,s1
     3a8:	708040ef          	jal	4ab0 <close>
  unlink("junk");
     3ac:	00005517          	auipc	a0,0x5
     3b0:	dc450513          	addi	a0,a0,-572 # 5170 <malloc+0x21c>
     3b4:	724040ef          	jal	4ad8 <unlink>

  exit(0);
     3b8:	4501                	li	a0,0
     3ba:	6ce040ef          	jal	4a88 <exit>
...
00000000000006e0 <truncate1>:
{
  ...
  write(fd1, "abcdef", 6);
     ...
     796:	854e                	mv	a0,s3
     798:	310040ef          	jal	4aa8 <write>
  n = read(fd3, buf, sizeof(buf));
     79c:	02000613          	li	a2,32
     7a0:	fa040593          	addi	a1,s0,-96
     7a4:	854a                	mv	a0,s2
     7a6:	2fa040ef          	jal	4aa0 <read>
  if(n != 6){
     7aa:	4799                	li	a5,6
  ...
  unlink("truncfile");
     ...
     7cc:	30c040ef          	jal	4ad8 <unlink>
  close(fd1);
     7d0:	854e                	mv	a0,s3
     7d2:	2de040ef          	jal	4ab0 <close>
  close(fd2);
     7d6:	8526                	mv	a0,s1
     7d8:	2d8040ef          	jal	4ab0 <close>
  close(fd3);
     7dc:	854a                	mv	a0,s2
     7de:	2d2040ef          	jal	4ab0 <close>
}
...
0000000000000b1e <unlinkread>:
{
  ...
  write(fd, "hello", SZ);
     ...
     b4e:	75b030ef          	jal	4aa8 <write>
  close(fd);
     b52:	8526                	mv	a0,s1
     b54:	75d030ef          	jal	4ab0 <close>
  fd = open("unlinkread", O_RDWR);
     b58:	4589                	li	a1,2
     b5a:	00005517          	auipc	a0,0x5
     b5e:	a2650513          	addi	a0,a0,-1498 # 5580 <malloc+0x62c>
     b62:	767030ef          	jal	4ac8 <open>
     b66:	84aa                	mv	s1,a0
  if(fd < 0){
...
0000000000000c74 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     cba:	5ef030ef          	jal	4aa8 <write>
     cbe:	4795                	li	a5,5
     cc0:	0cf51e63          	bne	a0,a5,d9c <linktest+0x128>
  close(fd);
     cc4:	8526                	mv	a0,s1
     cc6:	5eb030ef          	jal	4ab0 <close>
  if(link("lf1", "lf2") < 0){
...
0000000000000fd4 <pgbug>:
{
  ...
  exec(big, argv);
     ...
     fee:	6088                	ld	a0,0(s1)
     ff0:	2d1030ef          	jal	4ac0 <exec>
  pipe(big);
     ff4:	6088                	ld	a0,0(s1)
     ff6:	2a3030ef          	jal	4a98 <pipe>
  exit(0);
     ffa:	4501                	li	a0,0
     ffc:	28d030ef          	jal	4a88 <exit>
...
000000000000103e <copyinstr2>:
{
  ...
  if(pid == 0){
    ...
    exit(1);
    119c:	4505                	li	a0,1
    119e:	0eb030ef          	jal	4a88 <exit>
    exit(747); // OK
    11a2:	2eb00513          	li	a0,747
    11a6:	0e3030ef          	jal	4a88 <exit>
  int st = 0;
    11aa:	f4042a23          	sw	zero,-172(s0)
  wait(&st);
    11ae:	f5440513          	addi	a0,s0,-172
    11b2:	0df030ef          	jal	4a90 <wait>
  if(st != 747){
...
00000000000011dc <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    11f4:	0d5030ef          	jal	4ac8 <open>
    11f8:	0b9030ef          	jal	4ab0 <close>
  pid = fork();
...
000000000000133e <exectest>:
{
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    exit(1);
    14a8:	4505                	li	a0,1
    14aa:	5de030ef          	jal	4a88 <exit>
    exit(0);
    14ae:	4501                	li	a0,0
    14b0:	5d8030ef          	jal	4a88 <exit>
...
0000000000001650 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    16d0:	7d0030ef          	jal	4ea0 <printf>
        exit(1);
    16d4:	4505                	li	a0,1
    16d6:	3b2030ef          	jal	4a88 <exit>
      exit(i);
    16da:	854a                	mv	a0,s2
    16dc:	3ac030ef          	jal	4a88 <exit>
...
00000000000016e0 <twochildren>:
{
    ...
    1704:	c529                	beqz	a0,174e <twochildren+0x6e>
        wait(0);
    1706:	4501                	li	a0,0
    1708:	388030ef          	jal	4a90 <wait>
        wait(0);
    170c:	4501                	li	a0,0
    170e:	382030ef          	jal	4a90 <wait>
  for(int i = 0; i < 1000; i++){
    ...
    172c:	774030ef          	jal	4ea0 <printf>
      exit(1);
    1730:	4505                	li	a0,1
    1732:	356030ef          	jal	4a88 <exit>
      exit(0);
    1736:	352030ef          	jal	4a88 <exit>
        printf("%s: fork failed\n", s);
    173a:	85ca                	mv	a1,s2
    ...
    1744:	75c030ef          	jal	4ea0 <printf>
        exit(1);
    1748:	4505                	li	a0,1
    174a:	33e030ef          	jal	4a88 <exit>
        exit(0);
    174e:	33a030ef          	jal	4a88 <exit>
    ...
    17a8:	2e0030ef          	jal	4a88 <exit>
{
    ...
    17b8:	cd01                	beqz	a0,17d0 <forkfork+0x7e>
        wait(0);
    17ba:	4501                	li	a0,0
    17bc:	2d4030ef          	jal	4a90 <wait>
      for(int j = 0; j < 200; j++){
    17c0:	34fd                	addiw	s1,s1,-1
    17c2:	f4fd                	bnez	s1,17b0 <forkfork+0x5e>
      exit(0);
    17c4:	4501                	li	a0,0
    17c6:	2c2030ef          	jal	4a88 <exit>
          exit(1);
    17ca:	4505                	li	a0,1
    17cc:	2bc030ef          	jal	4a88 <exit>
          exit(0);
    17d0:	2b8030ef          	jal	4a88 <exit>
...
0000000000001830 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    18de:	1ea030ef          	jal	4ac8 <open>
        if(fd < 0){
    18e2:	fc0549e3          	bltz	a0,18b4 <createdelete+0x84>
        close(fd);
    18e6:	1ca030ef          	jal	4ab0 <close>
        if(i > 0 && (i % 2 ) == 0){
    ...
    191c:	584030ef          	jal	4ea0 <printf>
            exit(1);
    1920:	4505                	li	a0,1
    1922:	166030ef          	jal	4a88 <exit>
      exit(0);
    1926:	4501                	li	a0,0
    1928:	160030ef          	jal	4a88 <exit>
      exit(1);
    192c:	4505                	li	a0,1
    192e:	15a030ef          	jal	4a88 <exit>
...
0000000000001a08 <linkunlink>:
{
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    exit(1);
    1a78:	4505                	li	a0,1
    1a7a:	00e030ef          	jal	4a88 <exit>
      close(open("x", O_RDWR | O_CREATE));
    1a7e:	20200593          	li	a1,514
    1a82:	855a                	mv	a0,s6
    1a84:	044030ef          	jal	4ac8 <open>
    1a88:	028030ef          	jal	4ab0 <close>
  for(i = 0; i < 100; i++){
...
0000000000001ae4 <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    exit(1);
    1b18:	4505                	li	a0,1
    1b1a:	76f020ef          	jal	4a88 <exit>
      exit(0);
    1b1e:	76b020ef          	jal	4a88 <exit>
...
0000000000001b8c <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    1c0c:	294030ef          	jal	4ea0 <printf>
      exit(1);
    1c10:	4505                	li	a0,1
    1c12:	677020ef          	jal	4a88 <exit>
      exit(1);
    1c16:	4505                	li	a0,1
    1c18:	671020ef          	jal	4a88 <exit>
...
0000000000001c1c <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    1c9e:	202030ef          	jal	4ea0 <printf>
      exit(1);
    1ca2:	4505                	li	a0,1
    1ca4:	5e5020ef          	jal	4a88 <exit>
      exit(1);
    1ca8:	4505                	li	a0,1
    1caa:	5df020ef          	jal	4a88 <exit>
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    exit(1);
    1d06:	4505                	li	a0,1
    1d08:	581020ef          	jal	4a88 <exit>
    exit(0);
    1d0c:	4501                	li	a0,0
    1d0e:	57b020ef          	jal	4a88 <exit>
...
0000000000001d12 <nowrite>:
{
  ...
  exit(0);
    ...
    1da6:	0fa030ef          	jal	4ea0 <printf>
      exit(1);
    1daa:	4505                	li	a0,1
    1dac:	4dd020ef          	jal	4a88 <exit>
      exit(1);
    1db0:	4505                	li	a0,1
    1db2:	4d7020ef          	jal	4a88 <exit>
...
0000000000001db6 <manywrites>:
{
  ...
  exit(0);
    ...
    1ebc:	7e5020ef          	jal	4ea0 <printf>
            exit(1);
    1ec0:	4505                	li	a0,1
    1ec2:	3c7020ef          	jal	4a88 <exit>
      exit(st);
    1ec6:	3c3020ef          	jal	4a88 <exit>
...
0000000000001fce <rwsbrk>:
{
  ...
  if(n >= 0){
    ...
    exit(1);
    20c2:	4505                	li	a0,1
    20c4:	1c5020ef          	jal	4a88 <exit>
  close(fd);
    20c8:	854a                	mv	a0,s2
    20ca:	1e7020ef          	jal	4ab0 <close>
  exit(0);
    20ce:	4501                	li	a0,0
    20d0:	1b9020ef          	jal	4a88 <exit>
...
00000000000020d4 <sbrkbasic>:
{
  ...
  if(c != a + 1){
    ...
    exit(1);
    21f6:	4505                	li	a0,1
    21f8:	091020ef          	jal	4a88 <exit>
  if(pid == 0)
    21fc:	00091563          	bnez	s2,2206 <sbrkbasic+0x132>
    exit(0);
    2200:	4501                	li	a0,0
    2202:	087020ef          	jal	4a88 <exit>
  wait(&xstatus);
    2206:	fcc40513          	addi	a0,s0,-52
    220a:	087020ef          	jal	4a90 <wait>
  exit(xstatus);
    220e:	fcc42503          	lw	a0,-52(s0)
    2212:	077020ef          	jal	4a88 <exit>
...
0000000000002412 <argptest>:
{
  ...
  read(fd, sbrk(0) - 1, -1);
    ...
    2440:	8526                	mv	a0,s1
    2442:	65e020ef          	jal	4aa0 <read>
  close(fd);
    2446:	8526                	mv	a0,s1
    2448:	668020ef          	jal	4ab0 <close>
}
...
000000000000246c <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    exit(1);
    249c:	4505                	li	a0,1
    249e:	5ea020ef          	jal	4a88 <exit>
  wait(0);
    24a2:	4501                	li	a0,0
    24a4:	5ec020ef          	jal	4a90 <wait>
  pid = fork();
  ...
  if(pid == 0){
    ...
    exit(1);
    24d6:	4505                	li	a0,1
    24d8:	5b0020ef          	jal	4a88 <exit>
  wait(0);
    24dc:	4501                	li	a0,0
    24de:	5b2020ef          	jal	4a90 <wait>
  pid = fork();
  ...
  if(pid == 0){
    ...
    exit(1);
    2516:	4505                	li	a0,1
    2518:	570020ef          	jal	4a88 <exit>
  wait(0);
    251c:	4501                	li	a0,0
    251e:	572020ef          	jal	4a90 <wait>
  exit(0);
    2522:	4501                	li	a0,0
    2524:	564020ef          	jal	4a88 <exit>
...
0000000000002528 <sbrklast>:
{
  ...
  int fd = open(p, O_RDWR|O_CREATE);
    ...
    2572:	854a                	mv	a0,s2
    2574:	554020ef          	jal	4ac8 <open>
    2578:	89aa                	mv	s3,a0
  write(fd, p, 1);
    257a:	4605                	li	a2,1
    257c:	85ca                	mv	a1,s2
    257e:	52a020ef          	jal	4aa8 <write>
  close(fd);
    2582:	854e                	mv	a0,s3
    2584:	52c020ef          	jal	4ab0 <close>
  fd = open(p, O_RDWR);
    2588:	4589                	li	a1,2
    258a:	854a                	mv	a0,s2
    258c:	53c020ef          	jal	4ac8 <open>
  p[0] = '\0';
    2590:	fc048023          	sb	zero,-64(s1)
  read(fd, p, 1);
    2594:	4605                	li	a2,1
    2596:	85ca                	mv	a1,s2
    2598:	508020ef          	jal	4aa0 <read>
  if(p[0] != 'x')
...
00000000000025f8 <execout>:
{
  ...
  exit(0);
    ...
    268a:	436020ef          	jal	4ac0 <exec>
      exit(0);
    268e:	4501                	li	a0,0
    2690:	3f8020ef          	jal	4a88 <exit>
...
00000000000027d0 <diskfull>:
{
  ...
  for(fi = 0; done == 0 && '0' + fi < 0177; fi++){
    ...
    283e:	a039                	j	284c <diskfull+0x7c>
        close(fd);
    2840:	854a                	mv	a0,s2
    2842:	26e020ef          	jal	4ab0 <close>
    close(fd);
    2846:	854a                	mv	a0,s2
    2848:	268020ef          	jal	4ab0 <close>
  for(int i = 0; i < nzz; i++){
    284c:	4481                	li	s1,0
    name[0] = 'z';
  ...
  for(fi = 0; done == 0 && '0' + fi < 0177; fi++){
    ...
    29a0:	138020ef          	jal	4ad8 <unlink>
    int fd = open(name, O_CREATE|O_RDWR|O_TRUNC);
    29a4:	60200593          	li	a1,1538
    29a8:	b8040513          	addi	a0,s0,-1152
    29ac:	11c020ef          	jal	4ac8 <open>
    29b0:	892a                	mv	s2,a0
    if(fd < 0){
...
0000000000002a8a <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    2b1c:	384020ef          	jal	4ea0 <printf>
      exit(1);
    2b20:	4505                	li	a0,1
    2b22:	767010ef          	jal	4a88 <exit>
  wait(&xstatus);
    2b26:	fdc40513          	addi	a0,s0,-36
    2b2a:	767010ef          	jal	4a90 <wait>
  exit(xstatus);
    2b2e:	fdc42503          	lw	a0,-36(s0)
    2b32:	757010ef          	jal	4a88 <exit>
...
0000000000002bdc <subdir>:
{
  ...
  write(fd, "FF", 2);
    ...
    2c70:	639010ef          	jal	4aa8 <write>
  close(fd);
    2c74:	8526                	mv	a0,s1
    2c76:	63b010ef          	jal	4ab0 <close>
  fd = open("dd/dd/../ff", 0);
    2c7a:	4581                	li	a1,0
    2c7c:	00003517          	auipc	a0,0x3
    2c80:	72450513          	addi	a0,a0,1828 # 63a0 <malloc+0x144c>
    2c84:	645010ef          	jal	4ac8 <open>
    2c88:	84aa                	mv	s1,a0
  if(fd < 0){
...
00000000000034a0 <iref>:
{
    ...
    34fa:	1a7010ef          	jal	4ea0 <printf>
      exit(1);
    34fe:	4505                	li	a0,1
    3500:	588010ef          	jal	4a88 <exit>
      close(fd);
    3504:	5ac010ef          	jal	4ab0 <close>
    3508:	a82d                	j	3542 <iref+0xa2>
    unlink("xx");
    350a:	854e                	mv	a0,s3
    350c:	5cc010ef          	jal	4ad8 <unlink>
  for(i = 0; i < NINODE + 1; i++){
    3510:	397d                	addiw	s2,s2,-1
    3512:	04090263          	beqz	s2,3556 <iref+0xb6>
    if(mkdir("irefd") != 0){
    3516:	8552                	mv	a0,s4
    3518:	5d8010ef          	jal	4af0 <mkdir>
    351c:	f161                	bnez	a0,34dc <iref+0x3c>
    if(chdir("irefd") != 0){
    351e:	8552                	mv	a0,s4
    3520:	5d8010ef          	jal	4af8 <chdir>
    3524:	f571                	bnez	a0,34f0 <iref+0x50>
    mkdir("");
    3526:	8526                	mv	a0,s1
    3528:	5c8010ef          	jal	4af0 <mkdir>
    link("README", "");
    352c:	85a6                	mv	a1,s1
    352e:	8556                	mv	a0,s5
    3530:	5b8010ef          	jal	4ae8 <link>
    fd = open("", O_CREATE);
    3534:	20000593          	li	a1,512
    3538:	8526                	mv	a0,s1
    353a:	58e010ef          	jal	4ac8 <open>
    if(fd >= 0)
    353e:	fc0553e3          	bgez	a0,3504 <iref+0x64>
    fd = open("xx", O_CREATE);
    3542:	20000593          	li	a1,512
    3546:	854e                	mv	a0,s3
    3548:	580010ef          	jal	4ac8 <open>
    if(fd >= 0)
    354c:	fa054fe3          	bltz	a0,350a <iref+0x6a>
      close(fd);
    3550:	560010ef          	jal	4ab0 <close>
    ...
    chdir("..");
    356a:	854e                	mv	a0,s3
    356c:	58c010ef          	jal	4af8 <chdir>
    unlink("irefd");
    3570:	854a                	mv	a0,s2
    3572:	566010ef          	jal	4ad8 <unlink>
  for(i = 0; i < NINODE + 1; i++){
...
000000000000359a <openiputtest>:
{
  ...
  if(pid == 0){
    ...
    exit(1);
    3608:	4505                	li	a0,1
    360a:	47e010ef          	jal	4a88 <exit>
    exit(0);
    360e:	4501                	li	a0,0
    3610:	478010ef          	jal	4a88 <exit>
  sleep(1);
    3614:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
    ...
    exit(1);
    3636:	4505                	li	a0,1
    3638:	450010ef          	jal	4a88 <exit>
  wait(&xstatus);
    363c:	fdc40513          	addi	a0,s0,-36
    3640:	450010ef          	jal	4a90 <wait>
  exit(xstatus);
    3644:	fdc42503          	lw	a0,-36(s0)
    3648:	440010ef          	jal	4a88 <exit>
...
000000000000364c <forkforkfork>:
{
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    3680:	448010ef          	jal	4ac8 <open>
    3684:	42c010ef          	jal	4ab0 <close>
  wait(0);
    3688:	4501                	li	a0,0
    368a:	406010ef          	jal	4a90 <wait>
  sleep(10); // one second
    368e:	4529                	li	a0,10
    ...
    36da:	3ee010ef          	jal	4ac8 <open>
    36de:	3d2010ef          	jal	4ab0 <close>
    36e2:	bfe1                	j	36ba <forkforkfork+0x6e>
        exit(0);
    36e4:	4501                	li	a0,0
    36e6:	3a2010ef          	jal	4a88 <exit>
...
00000000000036ea <killstatus>:
{
    ...
    kill(pid1);
    3714:	8526                	mv	a0,s1
    3716:	3a2010ef          	jal	4ab8 <kill>
    wait(&xst);
    371a:	fcc40513          	addi	a0,s0,-52
    371e:	372010ef          	jal	4a90 <wait>
    if(xst != -1) {
  ...
  exit(0);
    ...
    3740:	760010ef          	jal	4ea0 <printf>
      exit(1);
    3744:	4505                	li	a0,1
    3746:	342010ef          	jal	4a88 <exit>
        getpid();
    374a:	3be010ef          	jal	4b08 <getpid>
      while(1) {
...
0000000000003764 <preempt>:
{
  ...
  if(pid2 == 0)
    ...
    exit(1);
    37b4:	4505                	li	a0,1
    37b6:	2d2010ef          	jal	4a88 <exit>
  pipe(pfds);
    37ba:	fc840513          	addi	a0,s0,-56
    37be:	2da010ef          	jal	4a98 <pipe>
  pid3 = fork();
  ...
  kill(pid1);
    386e:	8526                	mv	a0,s1
    3870:	248010ef          	jal	4ab8 <kill>
  kill(pid2);
    3874:	854e                	mv	a0,s3
    3876:	242010ef          	jal	4ab8 <kill>
  kill(pid3);
    387a:	8552                	mv	a0,s4
    387c:	23c010ef          	jal	4ab8 <kill>
  printf("wait... ");
  ...
  wait(0);
    388c:	4501                	li	a0,0
    388e:	202010ef          	jal	4a90 <wait>
  wait(0);
    3892:	4501                	li	a0,0
    3894:	1fc010ef          	jal	4a90 <wait>
  wait(0);
    3898:	4501                	li	a0,0
    389a:	1f6010ef          	jal	4a90 <wait>
...
00000000000038a0 <reparent>:
{
  ...
  exit(0);
    ...
    390a:	00054563          	bltz	a0,3914 <reparent+0x74>
      exit(0);
    390e:	4501                	li	a0,0
    3910:	178010ef          	jal	4a88 <exit>
        kill(master_pid);
    3914:	8552                	mv	a0,s4
    3916:	1a2010ef          	jal	4ab8 <kill>
        exit(1);
    391a:	4505                	li	a0,1
    391c:	16c010ef          	jal	4a88 <exit>
...
0000000000003920 <sbrkfail>:
{
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    kill(pids[i]);
    39c8:	0f0010ef          	jal	4ab8 <kill>
    wait(0);
    39cc:	4501                	li	a0,0
    39ce:	0c2010ef          	jal	4a90 <wait>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    exit(1);
    3a6e:	4505                	li	a0,1
    3a70:	018010ef          	jal	4a88 <exit>
    exit(1);
    3a74:	4505                	li	a0,1
    3a76:	012010ef          	jal	4a88 <exit>
...
0000000000003a7a <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    3ae2:	3be010ef          	jal	4ea0 <printf>
      exit(1);
    3ae6:	4505                	li	a0,1
    3ae8:	7a1000ef          	jal	4a88 <exit>
      exit(0);
    3aec:	4501                	li	a0,0
    3aee:	79b000ef          	jal	4a88 <exit>
...
0000000000003af2 <sharedfd>:
{
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    exit(1);
    3c52:	4505                	li	a0,1
    3c54:	635000ef          	jal	4a88 <exit>
    exit(0);
    3c58:	4501                	li	a0,0
    3c5a:	62f000ef          	jal	4a88 <exit>
...
0000000000003c5e <fourfiles>:
{
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    3d0c:	194010ef          	jal	4ea0 <printf>
      exit(1);
    3d10:	4505                	li	a0,1
    3d12:	577000ef          	jal	4a88 <exit>
      fd = open(fname, O_CREATE | O_RDWR);
    3d16:	20200593          	li	a1,514
    3d1a:	854e                	mv	a0,s3
    3d1c:	5ad000ef          	jal	4ac8 <open>
    3d20:	892a                	mv	s2,a0
      if(fd < 0){
    ...
    3d80:	120010ef          	jal	4ea0 <printf>
          exit(1);
    3d84:	4505                	li	a0,1
    3d86:	503000ef          	jal	4a88 <exit>
      exit(xstatus);
    3d8a:	8556                	mv	a0,s5
    3d8c:	4fd000ef          	jal	4a88 <exit>
          printf("%s: wrong char\n", s);
    3d90:	85e6                	mv	a1,s9
    ...
    close(fd);
    3dd2:	854e                	mv	a0,s3
    3dd4:	4dd000ef          	jal	4ab0 <close>
    if(total != N*SZ){
    3dd8:	03a91463          	bne	s2,s10,3e00 <fourfiles+0x1a2>
    unlink(fname);
    3ddc:	8562                	mv	a0,s8
    3dde:	4fb000ef          	jal	4ad8 <unlink>
  for(i = 0; i < NCHILD; i++){
...
0000000000003e32 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    3e9e:	002010ef          	jal	4ea0 <printf>
        exit(1);
    3ea2:	4505                	li	a0,1
    3ea4:	3e5000ef          	jal	4a88 <exit>
      link("C0", file);
    3ea8:	fa840593          	addi	a1,s0,-88
    3eac:	00003517          	auipc	a0,0x3
    3eb0:	e2c50513          	addi	a0,a0,-468 # 6cd8 <malloc+0x1d84>
    3eb4:	435000ef          	jal	4ae8 <link>
      exit(0);
    3eb8:	4501                	li	a0,0
    3eba:	3cf000ef          	jal	4a88 <exit>
        exit(1);
    3ebe:	4505                	li	a0,1
    3ec0:	3c9000ef          	jal	4a88 <exit>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    3f64:	73d000ef          	jal	4ea0 <printf>
        exit(1);
    3f68:	4505                	li	a0,1
    3f6a:	31f000ef          	jal	4a88 <exit>
  close(fd);
    3f6e:	854a                	mv	a0,s2
    3f70:	341000ef          	jal	4ab0 <close>
  if(n != N){
  ...
  for(i = 0; i < N; i++){
    ...
    3fa4:	6fd000ef          	jal	4ea0 <printf>
      exit(1);
    3fa8:	4505                	li	a0,1
    3faa:	2df000ef          	jal	4a88 <exit>
      close(open(file, 0));
    3fae:	4581                	li	a1,0
    3fb0:	fa840513          	addi	a0,s0,-88
    3fb4:	315000ef          	jal	4ac8 <open>
    3fb8:	2f9000ef          	jal	4ab0 <close>
      close(open(file, 0));
    3fbc:	4581                	li	a1,0
    3fbe:	fa840513          	addi	a0,s0,-88
    3fc2:	307000ef          	jal	4ac8 <open>
    3fc6:	2eb000ef          	jal	4ab0 <close>
      close(open(file, 0));
    3fca:	4581                	li	a1,0
    3fcc:	fa840513          	addi	a0,s0,-88
    3fd0:	2f9000ef          	jal	4ac8 <open>
    3fd4:	2dd000ef          	jal	4ab0 <close>
      close(open(file, 0));
    3fd8:	4581                	li	a1,0
    3fda:	fa840513          	addi	a0,s0,-88
    3fde:	2eb000ef          	jal	4ac8 <open>
    3fe2:	2cf000ef          	jal	4ab0 <close>
      close(open(file, 0));
    3fe6:	4581                	li	a1,0
    3fe8:	fa840513          	addi	a0,s0,-88
    3fec:	2dd000ef          	jal	4ac8 <open>
    3ff0:	2c1000ef          	jal	4ab0 <close>
      close(open(file, 0));
    3ff4:	4581                	li	a1,0
    3ff6:	fa840513          	addi	a0,s0,-88
    3ffa:	2cf000ef          	jal	4ac8 <open>
    3ffe:	2b3000ef          	jal	4ab0 <close>
    if(pid == 0)
    4002:	06090363          	beqz	s2,4068 <concreate+0x236>
      wait(0);
    4006:	4501                	li	a0,0
    4008:	289000ef          	jal	4a90 <wait>
  for(i = 0; i < N; i++){
    ...
    403a:	29f000ef          	jal	4ad8 <unlink>
      unlink(file);
    403e:	fa840513          	addi	a0,s0,-88
    4042:	297000ef          	jal	4ad8 <unlink>
      unlink(file);
    4046:	fa840513          	addi	a0,s0,-88
    404a:	28f000ef          	jal	4ad8 <unlink>
      unlink(file);
    404e:	fa840513          	addi	a0,s0,-88
    4052:	287000ef          	jal	4ad8 <unlink>
      unlink(file);
    4056:	fa840513          	addi	a0,s0,-88
    405a:	27f000ef          	jal	4ad8 <unlink>
      unlink(file);
    405e:	fa840513          	addi	a0,s0,-88
    4062:	277000ef          	jal	4ad8 <unlink>
    4066:	bf71                	j	4002 <concreate+0x1d0>
      exit(0);
    4068:	4501                	li	a0,0
    406a:	21f000ef          	jal	4a88 <exit>
      close(fd);
    406e:	243000ef          	jal	4ab0 <close>
    if(pid == 0) {
    4072:	b599                	j	3eb8 <concreate+0x86>
      close(fd);
    4074:	23d000ef          	jal	4ab0 <close>
      wait(&xstatus);
    4078:	f6c40513          	addi	a0,s0,-148
    407c:	215000ef          	jal	4a90 <wait>
      if(xstatus != 0)
...
00000000000040d6 <bigfile>:
{
  ...
  for(i = 0; ; i++){
    ...
    420e:	493000ef          	jal	4ea0 <printf>
      exit(1);
    4212:	4505                	li	a0,1
    4214:	075000ef          	jal	4a88 <exit>
  close(fd);
    4218:	8552                	mv	a0,s4
    421a:	097000ef          	jal	4ab0 <close>
  if(total != N*SZ){
...
000000000000425a <bigargtest>:
{
  ...
  fd = open("bigarg-ok", 0);
    ...
    4294:	035000ef          	jal	4ac8 <open>
  if(fd < 0){
    4298:	08054663          	bltz	a0,4324 <bigargtest+0xca>
  close(fd);
    429c:	015000ef          	jal	4ab0 <close>
}
    ...
    42ee:	7d2000ef          	jal	4ac0 <exec>
    fd = open("bigarg-ok", O_CREATE);
    42f2:	20000593          	li	a1,512
    42f6:	00003517          	auipc	a0,0x3
    42fa:	b7250513          	addi	a0,a0,-1166 # 6e68 <malloc+0x1f14>
    42fe:	7ca000ef          	jal	4ac8 <open>
    close(fd);
    4302:	7ae000ef          	jal	4ab0 <close>
    exit(0);
    4306:	4501                	li	a0,0
    4308:	780000ef          	jal	4a88 <exit>
    ...
    exit(1);
    431a:	4505                	li	a0,1
    431c:	76c000ef          	jal	4a88 <exit>
    exit(xstatus);
    4320:	768000ef          	jal	4a88 <exit>
...
run(void f(char *), char *s) {
  ...
  if(pid == 0) {
    ...
    exit(1);
    450e:	4505                	li	a0,1
    4510:	578000ef          	jal	4a88 <exit>
    f(s);
    4514:	854a                	mv	a0,s2
    4516:	9482                	jalr	s1
    exit(0);
    4518:	4501                	li	a0,0
    451a:	56e000ef          	jal	4a88 <exit>
      printf("OK\n");
...
countfree()
{
  ...
  if(pid == 0){
    ...
    exit(1);
    463c:	4505                	li	a0,1
    463e:	44a000ef          	jal	4a88 <exit>
      }
    }

    exit(0);
    4642:	4501                	li	a0,0
    4644:	444000ef          	jal	4a88 <exit>
    4648:	f426                	sd	s1,40(sp)
  }

  close(fds[1]);
    464a:	fcc42503          	lw	a0,-52(s0)
    464e:	462000ef          	jal	4ab0 <close>
  ...
  while(1){
    ...
    4678:	029000ef          	jal	4ea0 <printf>
      exit(1);
    467c:	4505                	li	a0,1
    467e:	40a000ef          	jal	4a88 <exit>
  }

  close(fds[0]);
    4682:	fc842503          	lw	a0,-56(s0)
    4686:	42a000ef          	jal	4ab0 <close>
  wait((int*)0);
    468a:	4501                	li	a0,0
    468c:	404000ef          	jal	4a90 <wait>
...
stat(const char *n, struct stat *st)
{
  ...
  r = fstat(fd, st);
    496a:	85ca                	mv	a1,s2
    496c:	174000ef          	jal	4ae0 <fstat>
    4970:	892a                	mv	s2,a0
  close(fd);
    4972:	8526                	mv	a0,s1
    4974:	13c000ef          	jal	4ab0 <close>
  return r;
